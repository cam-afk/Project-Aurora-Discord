...
from . import nealinsults

GUILD_ID = discord.Object(id=1279154864697511956)
...
class Core(commands.Cog):
    ...
    @app_commands.command(name="valrandom", description = "Press the button to get a random agent!!")
